...
namespace FishTraps.Options
{
  public class FishTrapsModSettings : ModSettings
  {
    ...
    public static int odysseyTrapCatchMultuplyValue = 6;
    public static float OdysseyTrapCatchMultiplier =>  0.1f * odysseyTrapCatchMultuplyValue;

    public static int odysseyNetCatchMultuplyValue = 10;
    public static float OdysseyNetCatchMultiplier => 0.1f * odysseyNetCatchMultuplyValue;
    ...
    public override void ExposeData()
    {
      ...
      Scribe_Values.Look<int>(ref odysseyTrapCatchMultuplyValue, "WFFT_odysseyTrapCatchMultuplyValue", 6, true);
      Scribe_Values.Look<int>(ref odysseyNetCatchMultuplyValue, "WFFT_odysseyNetCatchMultuplyValue", 10, true);
